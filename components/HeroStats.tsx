...
export const HeroStats: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  return (
    ...
    >
      <div className="flex flex-1 flex-col items-center justify-center" style={{ display: "none" }}>
      ...
      {maxStaked && (
        <>
          <div className="mx-6 my-auto hidden h-10 w-[1px] bg-border md:flex" style={{ display: "none" }}></div>
      ...
      {rewardDistributorData.data && (
        <>
          ...
          <div className="mx-6 my-auto hidden h-10 w-[1px] bg-border md:flex"
